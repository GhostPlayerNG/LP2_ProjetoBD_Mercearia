...
import Banco_de_Dados.BD_Funcionario;
 ...
 * @author gabri
 */
public class Fr_Cadastro_funcionario extends javax.swing.JFrame {

    private String Operacao;
    private Obj_Funcionario objRegFunc = new Obj_Funcionario();
    private BD_Funcionario bdFuncionario = new BD_Funcionario();
    private ArrayList<Obj_Funcionario> ListaFuncionario = new ArrayList();
    ...
    public Fr_Cadastro_funcionario() {
        initComponents();
        try {
            CargaTabela();
            CargaListaFuncionario();
            CargaListaUF();
            CargaListaCidade();
            CargaComboBoxUF();
            CargaComboBoxCidade();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar GRID Funcionario\n" + ex.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
        Operacao = "";
    }
    ...
    private void initComponents() {
        ...
        txt_cd_func = new javax.swing.JTextField();
                        ...
                        .addGroup(painel_dados_pessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(painel_dados_pessoaisLayout.createSequentialGroup()
                                ...
                                .addGroup(painel_dados_pessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(txt_data_nasc, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        painel_enderecoLayout.setHorizontalGroup(
            ...
            .addGroup(painel_enderecoLayout.createSequentialGroup()
                ...
                .addGroup(painel_enderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cmb_cidade, 0, 133, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        lbl_cod.setText("Código do Funcionario:");

        txt_cd_func.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txt_cd_func.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_cd_funcFocusLost(evt);
            }
        });
        txt_cd_func.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_cd_funcActionPerformed(evt);
            }
        });
        ...
        tb_func.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tb_func.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Nome", "DDD", "Telefone", "E-mail", "Sexo", "Data Nasc", "UF", "Cidade", "Endereço", "Data Registro"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(btn_limpar, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(43, 43, 43)
                .addComponent(btn_cadastrar, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_cd_func, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lbl_cod)
                            .addComponent(txt_cd_func, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addComponent(painel_endereco, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        if (Operacao.equals("Incluir")) {
            if (isCamposPreenchidos() == true) {
                carregaRegFuncionario();
                try {
                    cd_uf = bdestado.BuscaAbrvUF(objRegFunc.getEstado_Func());
                    objRegFunc.setCd_uf(cd_uf);
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Erro ao buscar UF\n" + ex.getMessage(), "ERRO BD", JOptionPane.ERROR_MESSAGE);
                }
                try {
                    cd_cidade = bdcidade.BuscaNomeCidade(objRegFunc.getCidade_Func());
                    objRegFunc.setCd_cidade(cd_cidade);
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Erro ao buscar Cidade\n" + ex.getMessage(), "ERRO BD", JOptionPane.ERROR_MESSAGE);
                }
                try {
                    if (bdFuncionario.IncluirFuncionario(objRegFunc)) {
                        CargaListaFuncionario();
                        JOptionPane.showMessageDialog(null, "Funcionario incluida com sucesso.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "Erro ao Incluir Funcionario. Erro de dados", "ERRO BD", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Erro ao acessar o BD \n" + ex.getMessage(), "Erro Incluir", JOptionPane.ERROR_MESSAGE);
                } finally {
                    try {
                        CargaTabela();
                        CargaListaFuncionario();
    ...
    private void txt_cd_funcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_cd_funcActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_cd_funcActionPerformed

    private void txt_cd_funcFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_cd_funcFocusLost
        // TODO add your handling code here:
        if (txt_cd_func.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha Código do Usuario para Consultar", "Erro Consulta", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                int codigo = Integer.parseInt(txt_cd_func.getText().trim());
                objRegFunc = bdFuncionario.ConsultaFuncionario(codigo);
                if (objRegFunc.getCd_Usuario() == 0) {
    ...
    }//GEN-LAST:event_txt_cd_funcFocusLost
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
        ...
        if (FuncSelecionado()) {
            ...
            if (resp == 0) {
                try {
                    if (bdFuncionario.ExcluiFunc(Integer.parseInt(txt_cd_func.getText().trim()))) {
                        JOptionPane.showMessageDialog(null, "Funcionario Excluída com Sucesso.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "Erro ao Excluir Funcionario. Erro Dados.", "ERRO BD", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception ex) {
            ...
            JOptionPane.showMessageDialog(null, "Selecione o Funcionario a Excluir", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btn_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_alterarActionPerformed
        ...
        if (Operacao.equals("Alterar")) {
            if (isCamposPreenchidos() == true) {
                ...
                try {
                    if (bdFuncionario.AlterarFuncionario(objRegFunc)) {
                        CargaListaFuncionario();
                        JOptionPane.showMessageDialog(null, "Funcionario alterada com sucesso.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "Erro ao Alterar Funcionario. Erro de dados", "ERRO BD", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Erro ao acessar o BD \n" + ex.getMessage(), "Erro Alterar", JOptionPane.ERROR_MESSAGE);
                } finally {
                    try {
                        CargaTabela();
                        CargaListaFuncionario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fr_Cadastro_funcionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fr_Cadastro_funcionario().setVisible(true);
            }
        });
    }

    public void limpar_campos() {
        txt_cd_func.setText(null);
    ...
    public void consiste_campos() {
        ...
        if (cmb_cidade.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Preencha a Cidade", "Erro Cidade", JOptionPane.ERROR_MESSAGE);
        }
        if (cmb_estado.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Preencha o Estado", "Erro Estado", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void consiste_numericos() {
        try {
            objRegFunc.setTel_Func(Integer.parseInt(txt_numero.getText().trim()));
            objRegFunc.setDdd_Func(Integer.parseInt(txt_ddd.getText().trim()));
    ...
    private void carregaRegFuncionario() {
        objRegFunc.setNome_Usuario(txt_nome.getText().trim());
        objRegFunc.setEmail_Func(txt_email.getText().trim());
        objRegFunc.setData_Nasc(txt_data_nasc.getText().trim());
        if (rbtn_M.isSelected()) {
            objRegFunc.setSexo_Func("Masculino");
        } else if (rbtn_F.isSelected()) {
            objRegFunc.setSexo_Func("Feminino");
        }
        objRegFunc.setEstado_Func(String.valueOf(cmb_estado.getSelectedItem()));
        objRegFunc.setCidade_Func(String.valueOf(cmb_cidade.getSelectedItem()));
        objRegFunc.setEndereco_Func(txt_endereco.getText().trim());
        objRegFunc.setData_adm(DataAtual());
        consiste_email();
        consiste_numericos();
    }
    ...
    private String DataAtual() {
        ...
        String dataAtual = formato.format(data_atual.getTime());
        System.out.println(data_atual.getTime());
        //String dataAtual = String.format("%t", data_atual.getTime());
        return dataAtual;
    }

    private void MontaTela() {
        txt_cd_func.setText(String.valueOf(objRegFunc.getCd_Usuario()));
        txt_nome.setText(objRegFunc.getNome_Usuario());
        txt_email.setText(objRegFunc.getEmail_Func());
        txt_data_nasc.setText(objRegFunc.getData_Nasc());
        txt_ddd.setText(String.valueOf(objRegFunc.getDdd_Func()));
        txt_numero.setText(String.valueOf(objRegFunc.getTel_Func()));
        cmb_cidade.setSelectedItem(objRegFunc.getCidade_Func());
        cmb_estado.setSelectedItem(objRegFunc.getEstado_Func());
        txt_endereco.setText(objRegFunc.getEndereco_Func());
        if (objRegFunc.getSexo_Func().equals("Masculino")) {
    ...
    private javax.swing.JTextField txt_cd_func;
    ...
    private void CargaTabela() throws Exception {
        try {
            DefaultTableModel modelo = (DefaultTableModel) tb_func.getModel();
            modelo.setNumRows(0);  // zera qtde de linhas tabela 
            modelo.setRowCount(0);
            for (Obj_Funcionario registro : bdFuncionario.CarregarListaFuncionario()) {
                modelo.addRow(new Object[]{registro.getCd_Usuario(), registro.getNome_Usuario(), registro.getDdd_Func(), registro.getTel_Func(), registro.getSexo_Func(), registro.getEmail_Func(), registro.getData_Nasc(), registro.getEstado_Func(), registro.getCidade_Func(), registro.getEndereco_Func(), registro.getData_adm()});
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Erro ao carregar GRID Funcionario\n" + ex.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void CarregaTabela_TextFileld() {
        objRegFunc.setCd_Usuario((int) tb_func.getValueAt(tb_func.getSelectedRow(), 0));
        objRegFunc.setNome_Usuario((String) tb_func.getValueAt(tb_func.getSelectedRow(), 1));
        objRegFunc.setDdd_Func((int) tb_func.getValueAt(tb_func.getSelectedRow(), 2));
        objRegFunc.setTel_Func((int) tb_func.getValueAt(tb_func.getSelectedRow(), 3));
        objRegFunc.setSexo_Func((String) tb_func.getValueAt(tb_func.getSelectedRow(), 4));
        objRegFunc.setEmail_Func((String) tb_func.getValueAt(tb_func.getSelectedRow(), 5));
        objRegFunc.setData_Nasc((String) tb_func.getValueAt(tb_func.getSelectedRow(), 6));
        objRegFunc.setEstado_Func((String) tb_func.getValueAt(tb_func.getSelectedRow(), 7));
        objRegFunc.setCidade_Func((String) tb_func.getValueAt(tb_func.getSelectedRow(), 8));
        objRegFunc.setEndereco_Func((String) tb_func.getValueAt(tb_func.getSelectedRow(), 9));
        objRegFunc.setData_adm((String) tb_func.getValueAt(tb_func.getSelectedRow(), 10));
    }

    private void CargaListaFuncionario() throws Exception {
        ListaFuncionario = bdFuncionario.CarregarListaFuncionario();
    }
    ...
    private boolean FuncSelecionado() {
        boolean saida = false;
        if (!txt_nome.getText().trim().isEmpty()
                && !txt_cd_func.getText().trim().isEmpty()) {
            saida = true;
        }
        return saida;
    }
